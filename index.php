...
<html lang="en">
  ...
  <body>
    ...
    <nav>
      <ul>
        <li id='nav-name'><a href=''><b>Terry Hayes</b></a></li>
    ...
    <div id='projects' class='section-container'>
      ...
      <div class='project' id='project1'>
        ...
        <p>
          ...
          rotating purchase categories, BestCard will allow you to always use
          the best card for each purchase; all you do is select the category
        </p>
        <a href="http://enigmatic-oasis-30651.herokuapp.com/">Demo the app here</a>
      ...
      <div class='project' id='project2'>
        ...
        <a href="https://cryptic-shore-50871.herokuapp.com/">Demo the app here</a>
      ...
      <div class='project' id='project3'>
        ...
        <a href="https://damp-ocean-99717.herokuapp.com/">Demo the app here</a>
    ...
    <div id='contact' class='section-container'>
      ...
      <ul>
        ...
        <li><b>Twitter</b> <a href="https://twitter.com/TCHayes">@TCHayes</a></li>
<!--Will likely remove Twitter from here as I don't regularly use the service any more.-->
